...
class TestBackendManager {
    constructor() {
        ...
        this.testMode = true;
        this.backendPath = path_1.default.resolve(__dirname, "..", "..", "Server");
        this.outputBuffer = [];
        this.errorBuffer = [];
    ...
    checkDependencies() {
        try {
            const packageJsonPath = path_1.default.join(this.backendPath, "package.json");
            if (!fs_1.default.existsSync(packageJsonPath)) {
                throw new Error("Server directory not found or package.json missing");
            }
            const nodeModulesPath = path_1.default.join(this.backendPath, "node_modules");
...
`);
    ...
    async startBackend() {
        try {
            ...
            this.backendProcess = (0, child_process_1.spawn)("node", ["dist/app.js"], {
                cwd: this.backendPath,
                env: env,
...
`);
    ...
    async waitForBackendReady(timeout = 30000) {
        ...
        while (Date.now() - startTime < timeout) {
            ...
            try {
                if (this.backendPort) {
                    const ws = new ws_1.default(`ws://localhost:${this.backendPort}`);
