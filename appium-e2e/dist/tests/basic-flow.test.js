...
test.describe("WMMT Remote Controller E2E Tests", () => {
    ...
    test("Basic App Launch and UI Verification", async () => {
        ...
        const startButtonExists = await device.elementExists("btn_start_service");
    ...
    test("Debug Mode Activation", async () => {
        ...
        try {
            ...
            console.log("Debug mode UI elements not found, skipping debug mode test");
    ...
    test("Overlay Permission Bypass Test", async () => {
        ...
        try {
            ...
            console.log("Overlay activation test skipped - UI elements not available");
        }
    });
});
