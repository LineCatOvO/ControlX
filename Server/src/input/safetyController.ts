...
export class SafetyController {
    ...
    constructor(
        ...
        this.config = {
            timeoutMs: 500, // 默认Timeout time 500ms
            ...config,
        };
    ...
    /**
     * 更新Current tickTime（Called by ApplyScheduler）
