 ...
 * 只有持有Valid令牌the module才能trigger清零Operation
 ...
 * 
 * Notes：
 * - 在 ApplyScheduler 未Start时，currentTickTime For 0，此时会回退到 Date.now()
 * - 这是临时Compatible机制，正式Run时必须ensure ApplyScheduler 先Start
 * ============================================================================
 */
export class SafetyController {
     ...
     * @param tickTime tick timestamp（provided by ApplyScheduler，Used forTime一致ity）
     */
     ...
     * 只有持有Valid令牌the module才能call此Method
     * @param reason Clear reason
    ...
    /**
     * Emergency clearing（无需Permission token，Used for紧急case）
    ...
    private checkTimeout(): void {
        ...
        // use currentTickTime（provided by ApplyScheduler）而not Date.now()
