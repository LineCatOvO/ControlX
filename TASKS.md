# WMMT Controller - 待完成任务清单

本文档包含项目所有未完成的任务，按优先级分类。
...
- [主逻辑设计 v1.1](doc/TechDesign/Server/MainLogic.md) - 执行逻辑设计
- [虚拟设备实现 v1.2](doc/TechDesign/Server/VirturalDeviceImplementation.md) - 设备实现方案
- [WebSocket 协议](doc/TechDesign/Server/protocol/websocket.md) - 通信协议规范
- [Android UI 渲染](doc/AndroidUiRendering.md) - 前端渲染方案
- [Android 布局计算](doc/AndroidUILayoutCalculation.md) - 布局引擎设计
