package com.linecat.controlx.e2e;

import com.linecat.controlx.e2e.util.JsonAssertions;
import com.linecat.controlx.service.RuntimeEvents;
...
public class ProfileSwitchE2E extends TestEnv {
    ...
    public void testProfileSwitchAndFullRelease() {
        ...
        runtimeConfig.setProfileId("official-profiles/controlx_gamepad_standard");
        ...
        android.content.Intent intent = new android.content.Intent(context, com.linecat.controlx.service.InputRuntimeService.class);
